    ...
    public class Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source = DESKTOP-L4917H9; Initial Catalog = projetoGamerManhaMVC; User Id = sa; pwd = Senai@134; TrustServerCertificate = true"); // --> gerenciador do banco de dados
